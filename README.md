...
- [better-codex](./skills/better-codex/SKILL.md): Guardrails for Codex coding work, including request validation, safer scope control, stale-edit prevention, general quality-first implementation, long-term maintainability, root-cause debugging, product/interface polish, meaningful tests, concise updates, and avoiding internal reasoning in user-facing UI.
